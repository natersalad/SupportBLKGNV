...
class AuthProvider extends ChangeNotifier {
  ...
  Future<bool> signIn(String email, String password) async {
    ...
    try {
      ...
      if (e.toString().contains('Signed in with mock user') && _authService.isLoggedInWithMockUser) {
        _setLoading(false);
        return true;
      }
  ...
  Future<bool> register(String email, String password, String name, String bio, String accountType) async {
    _setLoading(true);
    _setErrorMessage(null);
    ...
    try {
      ...
      // Special case for mock user
      if (e.toString().contains('Registered with mock user') && _authService.isLoggedInWithMockUser) {
        _setLoading(false);
        return true;
      }
